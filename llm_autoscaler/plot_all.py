...
LONG_DIR = BASE / "results_long_v2"  # hardened-sim v2 re-run (was results_long, pre-rework physics)
...
def main():
    ...
    parser.add_argument("--long-dir", default=None,
                        help="override long-sim results dir (default: results_long_v2)")
    args = parser.parse_args()
    dpi = args.dpi
    if args.long_dir:
        global LONG_DIR
        LONG_DIR = Path(args.long_dir)
        print(f"Using long-sim dir: {LONG_DIR}")
